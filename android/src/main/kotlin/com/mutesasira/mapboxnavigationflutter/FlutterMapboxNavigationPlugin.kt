...
class FlutterMapboxNavigationPlugin : FlutterPlugin, MethodCallHandler,
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(messenger, "mapbox_navigation_flutter")
        channel.setMethodCallHandler(this)

        progressEventChannel = EventChannel(messenger, "mapbox_navigation_flutter/events")
    ...
    override fun onMethodCall(call: MethodCall, result: Result) {
        when (call.method) {
            ...
            NavigationLauncher.stopNavigation(activity)
        }
            }
    ...
    private fun beginNavigation(wayPoints: List<Waypoint>) {
        currentActivity?.let { activity ->
            NavigationLauncher.startNavigation(activity, wayPoints)
        }
    }
    ...
    private fun addWayPointsToNavigation(
        ...
        currentActivity?.let { activity ->
            NavigationLauncher.addWayPoints(activity, wayPoints)
        }
    }
